...
public static class DbSeeder
{
    ...
    {
        new() { Name = "Atlético Nacional", City = "Medellín", CrestUrl =
            "https://placehold.co/80x80/006633/ffffff?text=NAC" },
        new() { Name = "Independiente Medellín", City = "Medellín", CrestUrl =
            "https://placehold.co/80x80/cc0000/ffffff?text=DIM" },
        new() { Name = "Millonarios", City = "Bogotá", CrestUrl =
            "https://placehold.co/80x80/003399/ffffff?text=MIL" },
        new() { Name = "Independiente Santa Fe", City = "Bogotá", CrestUrl =
            "https://placehold.co/80x80/cc0000/ffffff?text=SFE" },
        new() { Name = "América de Cali", City = "Cali", CrestUrl =
            "https://placehold.co/80x80/e60000/ffffff?text=AME" },
        new() { Name = "Deportivo Cali", City = "Cali", CrestUrl =
            "https://placehold.co/80x80/00794d/ffffff?text=CAL" },
        new() { Name = "Junior de Barranquilla", City = "Barranquilla", CrestUrl =
            "https://placehold.co/80x80/d40026/ffffff?text=JUN" },
        new() { Name = "Once Caldas", City = "Manizales", CrestUrl =
            "https://placehold.co/80x80/ffffff/000000?text=ONC" }
 };
